...
namespace CMS
{
    ...
    {
	    private IModuleManger moduleManger;
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
	        ...
	        var modules = moduleManger.GetModules().ToArray();
	    ...
	    private void ConfigureModulesServices(IServiceCollection services)
	    {
			...
			moduleManger.Register<CmsModule>();

			foreach (var module in moduleManger.GetModules())
			{
				//module.SetConfigurationRoot();
				module.ConfigureServices(services);
			}

			services.AddInstance(moduleManger);
		}
